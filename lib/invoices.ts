...
const profiles: Record<VendorProfileKey, VendorPortalProfile> = {
  landscaping: {
    ...
    dashboardTitle: "Landscape service account for Lakeside Towers HOA",
  ...
  plumber: {
    ...
    dashboardTitle: "Emergency plumbing account for Lakeside Towers HOA",
    dashboardDescription:
  ...
  doorking: {
    ...
    dashboardTitle: "Access systems account for Lakeside Towers HOA",
    dashboardDescription:
